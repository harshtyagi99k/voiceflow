...
return ( <div className="min-h-screen bg-dark-900 grid-bg flex items-center justify-center px-4 py-16"> <div className="orb w-[400px] h-[400px] bg-gold-500/6 top-0 left-1/2 -translate-x-1/2" />
  ...
  <div className="w-full max-w-md relative z-10">
    ...
    <div className="glass rounded-2xl p-8 border border-white/5">
      ...
      <button
        ...
        className="w-full glass border border-white/10 rounded-xl py-3 flex items-center justify-center gap-3 text-white/70 hover:text-white hover:border-white/20 transition-all mb-6"
      >
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <Link
              ...
              className="text-gold-400 text-xs hover:text-gold-300"
            >
              Forgot password?
            </Link>
          </div>
